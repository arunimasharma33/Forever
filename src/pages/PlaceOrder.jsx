  ...
  return (
    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input type='number' placeholder='Zip Code' className='border border-gray-300 rounder py-1.5 px-3.5 w-full'/>
          <input type='text' placeholder='Country' className='border border-gray-300 rounder py-1.5 px-3.5 w-full'/>
        </div>
        <input type='number' placeholder='Phone' className='border border-gray-300 rounder py-1.5 px-3.5 w-full'/>
      </div>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button className='bg-black text-white text-sm px-12 py-3'
