    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p>At Forever, we believe that style should last beyond trends and seasons. Our curated collection of fashion, accessories, and lifestyle products is designed with timeless appeal, ensuring you always look your best — no matter the occasion.</p>
          ...
          <p>Explore our collections, discover new favorites, and become a part of the Forever community. Because style, just like memories, should last forever. </p>
          <b>Our Mission</b>
          <p>
            At Forever, we are dedicated to offering timeless, high-quality products that combine style, comfort, and sustainability. Our goal is to empower individuals to express their unique selves with enduring fashion choices while contributing to a more sustainable future.</p>
